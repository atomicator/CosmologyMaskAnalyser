...
--threads=10 --iterations=100 --target="$target" --overdensity=0.1111111 --invert_bias=True --data_mask="$mask"
python3 ../code/binned_results/$file.py --path="${mask}_${target}_-0.2.npy" --raise_dir=1 --processes=10  \
--threads=10 --iterations=100 --target="$target" --overdensity=0.25 --invert_bias=True --data_mask="$mask"