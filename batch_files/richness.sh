...
python3 "./../code/binned_results/debug_script.py" --raise_path=1 --catalogue="sdss_filtered" --weight_function="excess" --save_path="./act_r_bin_3.png" --min_r=20.0  --max_r=50.0 --mask_set="point"  --data_mask="sdss_act" &python3 "./../code/binned_results/debug_script.py" --raise_path=1 --catalogue="sdss_filtered" --weight_function="excess" --save_path="./act_r_bin_3.png" --min_r=12.1 --max_r=18.7 --mask_set="point" --data_mask="sdss_act" &
python3 "./../code/binned_results/debug_script.py" --raise_path=1 --catalogue="sdss_filtered" --weight_function="excess" --save_path="./act_r_bin_3.png" --min_r=50.0 --max_r=100.0 --mask_set="point"  --data_mask="sdss_act" &
...
python3 "./../code/binned_results/debug_script.py" --raise_path=1 --catalogue="sdss_filtered" --weight_function="excess" --save_path="./act_r_min_3.png" --min_r=100.0 --mask_set="point"  --data_mask="sdss_act" &
...
python3 "./../code/binned_results/debug_script.py" --raise_path=1 --catalogue="sdss_filtered" --weight_function="excess" --save_path="./planck_r_bin_3.png" --min_r=50.0 --max_r=100.0 --mask_set="point" --data_mask="sdss_planck" &
...
python3 "./../code/binned_results/debug_script.py" --raise_path=1 --catalogue="sdss_filtered" --weight_function="excess" --save_path="./planck_r_min_3.png" --min_r=100.0 --mask_set="point" --data_mask="sdss_planck" &
